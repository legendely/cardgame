...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("img/cards/cards.zip.zip", "img/cards/cards.zip.zip");
		type.set ("img/cards/cards.zip.zip", AssetType.BINARY);
		path.set ("img/cards/kaart1.jpg", "img/cards/kaart1.jpg");
		...
		path.set ("img/cards/kaart5.jpg", "img/cards/kaart5.jpg");
		type.set ("img/cards/kaart5.jpg", AssetType.IMAGE);
		path.set ("img/cards/kaart6.jpg", "img/cards/kaart6.jpg");
		type.set ("img/cards/kaart6.jpg", AssetType.IMAGE);
		path.set ("img/cards/kaart7.jpg", "img/cards/kaart7.jpg");
		type.set ("img/cards/kaart7.jpg", AssetType.IMAGE);
		path.set ("img/cards/kaart8.jpg", "img/cards/kaart8.jpg");
		type.set ("img/cards/kaart8.jpg", AssetType.IMAGE);
		path.set ("img/cards/kaart9.jpg", "img/cards/kaart9.jpg");
		type.set ("img/cards/kaart9.jpg", AssetType.IMAGE);
		path.set ("img/cards/kaartback.jpg", "img/cards/kaartback.jpg");
		type.set ("img/cards/kaartback.jpg", AssetType.IMAGE);
		path.set ("img/cards/player1.jpg", "img/cards/player1.jpg");
		type.set ("img/cards/player1.jpg", AssetType.IMAGE);
		path.set ("img/cards/player1turn.jpg", "img/cards/player1turn.jpg");
		type.set ("img/cards/player1turn.jpg", AssetType.IMAGE);
		path.set ("img/cards/player2.jpg", "img/cards/player2.jpg");
		type.set ("img/cards/player2.jpg", AssetType.IMAGE);
		path.set ("img/cards/player2turn.jpg", "img/cards/player2turn.jpg");
		type.set ("img/cards/player2turn.jpg", AssetType.IMAGE);
		path.set ("img/cards/set.png", "img/cards/set.png");
		type.set ("img/cards/set.png", AssetType.IMAGE);
		path.set ("img/numbers.jpg", "img/numbers.jpg");
		type.set ("img/numbers.jpg", AssetType.IMAGE);
		path.set ("img/openfl.svg", "img/openfl.svg");
		type.set ("img/openfl.svg", AssetType.TEXT);
		path.set ("img/start.jpg", "img/start.jpg");
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "img/cards/player1turn.jpg";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "img/cards/player2.jpg";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "img/cards/player2turn.jpg";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
